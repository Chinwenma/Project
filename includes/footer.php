    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 mb-30">
          <h6 class="color-white mb-20">About Shop</h6>
          <p class="color-white body-p2 desc-company">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Read more</p>
          <p class="color-white body-p2 email-footer">E. <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="f39b969f9f9cb3868b839681dd909c">[email&#160;protected]</a></p>
          <p class="color-white body-p2 phone-footer">T. (00) 342 489 33</p>
        </div>
    ...
    <div class="container">
      <div class="footer-bottom">
        <div class="row align-items-center">
          <div class="col-lg-6 col-md-12 text-center text-lg-start mb-20"><span class="body-p1 color-white">© 2023 Guza.Co. All rights reserved</span></div>
          <div class="col-lg-6 col-md-12 text-center text-lg-end mb-20">
            <div class="d-flex justify-content-center justify-content-lg-end align-items-center box-all-payments">
              <div class="d-inline-block box-payments mr-20"><img src="assets/imgs/template/icons/visa.svg" alt=""><img src="assets/imgs/template/icons/master.svg" alt=""><img src="assets/imgs/template/icons/stripe.svg" alt=""><img src="assets/imgs/template/icons/paypal.svg" alt=""></div>
