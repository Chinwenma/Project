                           ...
                           <div class="card-header">
                            ...
                            <div class="card-body">
                                <form action="code.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <input name="meta_title" value="<?= $data['meta_title'] ?>" placeholder="Enter Meta Title" class="form-control">
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea rows="3" name="meta_keywords" placeholder="Enter Meta keyword" class="form-control"><?= $data['meta_keywords'] ?> </textarea>
                                        </div>
                                        <div class="col-md-6 ">
